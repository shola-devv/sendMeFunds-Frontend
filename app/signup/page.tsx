...
export default function Signup() {
  ...
  const fields = [
    { label: 'Full Name',  name: 'name',     type: 'text',     placeholder: 'Emmanuel Fayinminu', icon: '👤' },
    { label: 'Email',      name: 'email',    type: 'email',    placeholder: 'you@example.com',    icon: '✉️' },
    { label: 'Phone',      name: 'phone',    type: 'tel',      placeholder: '09159925467',        icon: '📱' },
    ...
    <main className="min-h-screen flex flex-col bg-[#050810] text-white overflow-hidden relative">
      <style>{`
        ...
        * { font-family: 'Syne', sans-serif; }
        ...
        .fade-up-5{ animation: fadeUp 0.8s 0.5s cubic-bezier(0.16,1,0.3,1) forwards; opacity:0; }
      ...
      {/* Background image — left side only, fades right */}
      ...
      {/* Orbs */}
      <FloatingOrb className="w-[500px] h-[500px] bg-blue-700 -top-48 -left-48" />
      <FloatingOrb className="w-[300px] h-[300px] bg-indigo-800 bottom-0 right-0" />
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="fade-up-1 mb-8">
            ...
            <p className="text-slate-400 text-sm">Join SendMeFunds in seconds. No paperwork.</p>
          </div>
          ...
          <div className="fade-up-2 relative rounded-2xl border border-blue-900/40 bg-white/[0.03] backdrop-blur-xl p-6 shadow-[0_32px_64px_rgba(0,0,30,0.5)]">
            ...
            <div className="space-y-4">
              {fields.map((f, i) => (
                <div key={f.name} style={{ animationDelay: `${0.25 + i * 0.08}s` }} className="fade-up">
          ...
          {/* Sign in link */}
          <p className="fade-up-5 mt-6 text-center text-xs text-slate-500">
          ...
          {/* Trust badges */}
          <div className="fade-up-5 mt-8 flex items-center justify-center gap-6">
